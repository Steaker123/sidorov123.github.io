<div class="page-header"><h1>Конкурс инвесторов</h1></div>

<div class="silver-bk"><div class="clr"></div>	
<center><a href = "/?menu=admin7pan15&sel=invcompconfig" class="stn">Текущий конкурс</a> || <a href = "/?menu=admin7pan15&sel=invcompconfig&add" class="stn">Добавить Конкурс</a> || <a href = "/?menu=admin7pan15&sel=invcompconfig&list" class="stn">Завершенные</a></center>
<BR />
<?PHP
...
<table width="300" border="0" align="center">
  ...
  <tr>
    <td>Приз за 1 место Руб:</td>
    <td align="center"><input type="text" name="1m" value="10" size="10"/></td>
  </tr>
  <tr>
    <td>Приз за 2 место Руб:</td>
    <td align="center"><input type="text" name="2m" value="5" size="10"/></td>
  </tr>
  <tr>
    <td>Приз за 3 место Руб:</td>
    <td align="center"><input type="text" name="3m" value="3" size="10"/></td>
  </tr>
  <tr>
    <td>Приз за 4 место Руб:</td>
    <td align="center"><input type="text" name="4m" value="2" size="10"/></td>
  </tr>
  <tr>
    <td>Приз за 5 место Руб:</td>
...
if(isset($_POST["set_ok"])){
	...
	if($db->NumRows() == 1){
		...
		# зачисляем бонус
		$db->Query("SELECT * FROM db_invcompetition_users WHERE points > '0' ORDER BY points DESC LIMIT 5");
		if($db->NumRows() > 0){
