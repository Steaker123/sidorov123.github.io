...
<center><a href="/?menu=admin7pan15&sel=payments">Выплачено</a> || <a href="/?menu=admin7pan15&sel=payments&balance">Баланс на Payeer</a> || 
<a href="/?menu=admin7pan15&sel=payments&list_day">По дням</a> || <a href="/?menu=admin7pan15&sel=payments&last_31">График за 30 дней</a></center><BR />
<?PHP
# График
...
<?PHP
	...
	?>
	<tr class="htt">
	<td align="center"><a href="/?menu=admin7pan15&sel=users&edit=<?=$data["user_id"]; ?>" class="stn"><?=$data["user"]; ?></a></td>
...
$all_pages = $db->FetchRow();
	...
	echo "<BR /><center>".$nav->Navigation(10, $page, ceil($all_pages / 100), "/?menu=admin7pan15&sel=payments&page="), "</center>";
