<div class="page-header">
	<h1>Конкурс рефералов</h1>
</div>
<div class="silver-bk">
<center><a href = "/?menu=admin7pan15&sel=compconfig" class="stn">Текущий конкурс</a> || <a href = "/?menu=admin7pan15&sel=compconfig&add" class="stn">Добавить Конкурс</a> || <a href = "/?menu=admin7pan15&sel=compconfig&list" class="stn">Завершенные</a></center>
<BR />
<?PHP
...
$comp = $db->FetchArray();	
	?>
<b>Конкурс рефералов № <?=$comp["id"]; ?> с общим призовым фондом <?=$comp["1m"]+$comp["2m"]+$comp["3m"]+$comp["4m"]+$comp["5m"]; ?> RUB<BR /><BR />
